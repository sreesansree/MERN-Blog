    ...
    <Footer container className="border border-t-8  border-teal-400">
      <div className="w-full mx-w-7xl mx-auto">
        ...
        <div className=" w-full sm:flex sm:items-center sm:justify-between ">
          <Footer.Copyright
            href="#"
            by="Sreesankar's blog"
            year={new Date().getFullYear()}
          />
          <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
            <Footer.Icon href="#" icon={BsFacebook} />
            <Footer.Icon href="#" icon={BsInstagram} />
            <Footer.Icon href="https://github.com/sreesansree" icon={BsGithub} />
            <Footer.Icon href="https://www.linkedin.com/in/sreesankar-p/" icon={BsLinkedin} />
          </div>
        </div>
      </div>
    </Footer>
